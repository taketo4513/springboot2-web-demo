...
public class FtpUtil {
    ...
    public boolean changeDirectory(String path) {
        ...
        try {
            ...
            logger.error("changeDirectory error ", e);
        } finally {
            ftpPoolService.returnObject(ftpClient);
        }
        return result;
    ...
    public boolean createDirectory(String pathName) {
        ...
        try {
            ...
            logger.error("createDirectory error ", e);
        } finally {
            ftpPoolService.returnObject(ftpClient);
        }
        return result;
    ...
    public boolean removeDirectory(String path) {
        ...
        try {
            ...
            logger.error("removeDirectory error ", e);
        } finally {
            ftpPoolService.returnObject(ftpClient);
        }
        return result;
    ...
    public boolean isDirectoryExists(String path) {
        ...
        try {
            ...
            logger.error("isDirectoryExists error ", e);
        } finally {
            ftpPoolService.returnObject(ftpClient);
        }
        return flag;
    ...
    public UploadStatus upload(String local, String remote) {
        ...
        try {
            ftpClient.changeWorkingDirectory(ftpPoolService.getFtpProperties().getBasePath());
            // 设置PassiveMode传输
            ftpClient.enterLocalPassiveMode();
            // 设置以二进制流的方式传输
            ftpClient.setFileType(FTP.BINARY_FILE_TYPE);
            ...
            if (remote.contains("/")) {
                ...
                if (createDirectory(remote, ftpClient) == UploadStatus.CreateDirectoryFail) {
